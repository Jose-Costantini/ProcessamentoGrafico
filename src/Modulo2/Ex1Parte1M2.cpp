...
int main()
{
	...
	//VAOs.push_back(createTriangle(0.65, 0.33, 0.27, 0.53, 0.61, 0.79));
	//VAOs.push_back(createTriangle(-0.65, -0.33, -0.27, -0.53, -0.61, -0.79));
	//VAOs.push_back(createTriangle(-0.5, 0, 0.5, 0, 0, 0.5));
	...
	glUniform4f(colorLoc, 0.0f, 0.0f, 1.0, 1.0f); // enviando cor para variável uniform inputColor. Envia a cor apenas uma vez fora do loop, já que ela não mudará.
